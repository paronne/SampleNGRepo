...
# LAUNCH
java -Xms40m -Xmx512m -XX:MaxPermSize=256M -Djava.awt.headless=true -cp "$cp" org.eclipse.equinox.launcher.Main -application com.servoy.eclipse.exporter.war.application "$@"